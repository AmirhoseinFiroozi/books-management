...
public class ReportCondition {
    ...
    public void addPersianLikeCondition(String fieldName, String input) {
        if (input != null) {
            ReportCondition nameCondition = new ReportCondition();
            nameCondition.addCaseInsensitiveLikeCondition(fieldName, input);
            if (input.startsWith("ا")) {
                nameCondition.addCaseInsensitiveLikeCondition(fieldName, input.replaceFirst("ا", "آ"));
            }
            if (input.contains(" ا")) {
                nameCondition.addCaseInsensitiveLikeCondition(fieldName, input.replace(" ا", " آ"));
            }
            this.addOrCondition(nameCondition);
        }
    }
